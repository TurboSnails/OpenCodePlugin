...
export function checkBinaries(config, ctx) {
...
export function checkAuthenticated(config, ctx) {
    const problems = [];
...
export async function checkWritability(config, run) {
    const failures = [];
...
//# sourceMappingURL=delegate-checks.js.map