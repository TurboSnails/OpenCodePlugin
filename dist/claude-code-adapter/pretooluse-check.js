...
export function checkPreToolUse(input, config) {
    const delegateTools = new Set(Object.keys(config.delegates).flatMap((name) => [mcpToolName(name, "start"), mcpToolName(name, "reply")]));
...
//# sourceMappingURL=pretooluse-check.js.map